...
def get_readable_time(seconds: int) -> str:
    ...
    return ping_time
PM_START_TEXT = """
`𝙷𝚎𝚕𝚕𝚘` [👸](https://ibb.co/xhCxQ18) `𝙼𝚢 𝚗𝚊𝚖𝚎 𝚒𝚜` *MaltexadeTv Princess*
`My job is to send movie links to MaltexadeTv. And I can also 𝚑𝚎𝚕𝚙 𝚢𝚘𝚞 𝚖𝚊𝚗𝚊𝚐𝚎 𝚢𝚘𝚞𝚛 𝚐𝚛𝚘𝚞𝚙𝚜! 𝙷𝚒𝚝` *📚𝙲𝚘𝚖𝚖𝚊𝚗𝚍𝚜*   
"""
buttons = [
    [
        InlineKeyboardButton(
            text="𝐀𝐝𝐝 𝐌𝐞 𝐓𝐨 𝐘𝐨𝐮𝐫 𝐆𝐫𝐨𝐮𝐩", url="t.me/maltexadetvprincessbot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="𝐀𝐛𝐨𝐮𝐭", callback_data="evil_"),
        InlineKeyboardButton(
            text="𝐌𝐲 Channel", url=f"http://t.me/maltexadetv"
        ),
     ],
     [  
        InlineKeyboardButton(text="𝐒𝐮𝐩𝐩𝐨𝐫𝐭", url="https://t.me/maltexadetv"),
        InlineKeyboardButton(text="𝐑𝐞𝐩𝐨", url="https://github.com/maltexade1/EvilBot"),
    ], 
...
HELP_STRINGS = """
`𝙷𝚎𝚢!.. 𝙸'𝚖` 👸 *MaltexadeTv Princess* [👸](https://telegra.ph/file/a064bd8497a5f6f03b290.mp4)
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paypal](#) or by contacting @maltexade \
